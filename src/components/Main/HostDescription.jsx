...
const HostDescription = () => {
  ...
  // Set progress
  // Step 2 - Second segment complete: 66%
  useEffect(() => {
        ...
        <div className="w-full">
          ...
          <div className="w-full">
            <textarea
              ...
              placeholder="Take it easy at this unique and tranquil getaway."
              maxLength={500}
              rows={8}
              className="w-full px-4 py-4 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 resize-none"
            />
