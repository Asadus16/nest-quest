...
import airbnb from "../../asset/nestLogo.svg";
...
// Brand Promotion Component
const NestQuestPromotion = () => (
  <div className="py-5">
    <div className="w-full border shadow-priceCardShadow border-grey-light-50 flex items-center rounded-lg p-6">
      <div className="w-full flex justify-between items-center">
        <div className="flex gap-y-1 flex-col">
          <span className="text-lg font-medium">Nest Quest your place</span>
...
const SupportSection = () => (
  <div className="py-5">
    ...
    <div className="flex py-5 border-b border-grey-light-50 flex-col gap-y-5">
      ...
      <NavigationItem
        icon={airbnb}
        text="How Nest Quest works"
        altText="how Nest Quest works"
      />
    </div>
  </div>
);
