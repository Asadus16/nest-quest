...
const NESTQUEST_LINKS = [
  "Newsroom",
  "New features",
  "Careers",
  "Investors",
  "Nest Quest Care emergency stays",
];
...
const Breadcrumb = () => (
  <div className="py-8 items-center gap-x-1 flex">
    {["Nest Quest", "United states", "California", "Los Angeles"].map(
      (item, index) => (
...
// Main Component
const LongFooter = () => {
  const { isProfilePage, isHouseDetailPage, isHomePage } = useFooterVisibility();
      ...
      <div className="h-full 1lg:px-20">
        <div className="1xz:mx-20 mx-5 h-full">
          <div className="w-full h-full 1md:grid 1md:grid-cols-3 flex flex-col relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1px] after:bg-grey-dim">
            ...
            {/* <LinkColumn title="Nest Quest" links={NESTQUEST_LINKS} /> */}
          </div>
        </div>
      </div>
